...
import com.etherealscope.invoices.service.InvoiceService;
...
public class InvoiceResource {
    ...
    @GetMapping("/invoices")
    @Timed
    public ResponseEntity<List<InvoiceDTO>> getAllInvoices(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        ...
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, String.format("/api/invoices?eagerload=%b", eagerload));
